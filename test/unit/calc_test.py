...
class TestCalculate(unittest.TestCase):
    ...
    def test_multiply_method_returns_correct_result(self):
        self.assertEqual(2, self.calc.multiply(2, 2))
        self.assertEqual(22, self.calc.multiply(11, 2))

    def test_power_method_returns_correct_result(self):
        self.assertEqual(2, self.calc.power(2, 1))
        self.assertEqual(1000, self.calc.power(10, 3))

    def test_sqrt_method_returns_correct_result(self):
        self.assertEqual(3, self.calc.sqrt(9))
        self.assertEqual(11, self.calc.sqrt(121))
